...
//				get_file_upload_url();	//è°ƒè¯•æ—¶ä½¿ç”¨ ç›´æŽ¥åœ¨tboxä¸Šåˆ›å»ºä¸€ä¸ªæ–‡ä»¶ ä¸ç”¨mcuä¸Šä¼ canæŠ¥æ–‡
			}
...
void tboxUploadFileDeal(char *buf){	
	switch(buf[CHECK_CMD_NUM_ADDR]){
		case 0x01:
			...
			break;
		case 0x02:
			//æœåŠ¡å™¨æ ¹æ®æ–‡ä»¶ä¸Šä¼ æƒ…å†µä¸‹å‘ç¡®è®¤æŒ‡ä»¤
		default:
			break;
	}
}
